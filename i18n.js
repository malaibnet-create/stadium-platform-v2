(function () {
  ...
  const arToEn = {
    ...
    'جار التحقق': 'Checking',
    'أقرب مواعيد': 'Next available dates',
    'إعادة المحاولة': 'Retry',
    'جميع المواعيد بتوقيت المغرب.': 'All times are shown in Morocco local time.',
    'جاري التحقق من الوقت والمواعيد...': 'Checking the time and availability...',
    'تعذر تحديث المواعيد. تحقق من اتصالك واضغط إعادة المحاولة.': 'Could not refresh availability. Check your connection and tap Retry.',
    'ساعات عمل الملعب غير صالحة. يرجى التواصل مع المسؤول.': 'The opening hours are invalid. Please contact the stadium manager.',
    'اختر موعدًا متاحًا للحجز.': 'Choose an available time to book.',
    'هذا الموعد انتهى. اختر موعدًا قادمًا.': 'This time has passed. Choose a future time.',
    'الموعد خارج ساعات عمل الملعب.': 'This time is outside the stadium opening hours.',
    'صيغة التاريخ أو الساعة غير صالحة.': 'The date or time is invalid.',
    'أسعار الملعب غير صالحة.': 'The stadium prices are invalid.',
    'هذه المواعيد محجوزة بالفعل.': 'These times are already booked.',
    'تعذر تأكيد الحجز. تحقق من الجدول قبل المحاولة مجددًا.': 'Could not confirm the booking. Check the timetable before trying again.',
